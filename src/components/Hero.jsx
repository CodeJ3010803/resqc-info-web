...
const Hero = () => {
    return (
        <section className="pt-24 md:pt-40 pb-14 md:pb-32 bg-white overflow-hidden">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-12">
                    ...
                    <div className="flex-1 text-left w-full">
                        <Reveal>
                            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black text-[#1e293b] tracking-tighter leading-none">
                                RES<span className="text-[#ef4444]">QC</span>
                            </h1>

                            <p className="mt-3 md:mt-4 text-lg sm:text-xl md:text-2xl font-bold text-[#475569] tracking-tight">
                                Smart Emergency Response Ecosystem
                            </p>

                            <p className="mt-5 md:mt-6 max-w-lg text-base sm:text-lg text-slate-500 leading-relaxed font-normal">
                                Connecting citizens with emergency responders through <br className="hidden lg:block" />
                                <span className="text-slate-700">intelligent routing</span> and <span className="text-slate-700">real-time coordination</span>.
                            </p>

                            <div className="mt-7 md:mt-8 inline-flex items-center gap-2 px-4 py-2 rounded-full border border-blue-200 bg-blue-50/30 text-[#2563eb] text-[11px] md:text-xs font-bold tracking-wider uppercase">
                        ...
                        <Reveal>
                            ...
                            >
                                ...
                                <img 
                                    ...
                                    className="relative z-10 w-full max-w-[240px] sm:max-w-[320px] md:max-w-none md:w-[500px] lg:w-[600px] xl:w-[680px] h-auto drop-shadow-xl"
                                />
                            </motion.div>
                        </Reveal>
                    </div>
